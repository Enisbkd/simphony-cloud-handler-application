...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, mc.sbm.simphonycloud.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, mc.sbm.simphonycloud.repository.UserRepository.USERS_BY_EMAIL_CACHE);
