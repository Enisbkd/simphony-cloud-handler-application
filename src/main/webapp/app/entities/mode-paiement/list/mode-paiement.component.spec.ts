...
import { sampleWithRequiredData } from '../mode-paiement.test-samples';
...
describe('ModePaiement Management Component', () => {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.modePaiements()[0]).toEqual(expect.objectContaining({ id: 18358 }));
  });

  describe('trackId', () => {
    it('should forward to modePaiementService', () => {
      const entity = { id: 18358 };
      jest.spyOn(service, 'getModePaiementIdentifier');
      const id = comp.trackId(entity);
      expect(service.getModePaiementIdentifier).toHaveBeenCalledWith(entity);
