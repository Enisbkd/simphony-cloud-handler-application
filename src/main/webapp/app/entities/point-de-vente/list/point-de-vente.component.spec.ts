...
import { sampleWithRequiredData } from '../point-de-vente.test-samples';
...
describe('PointDeVente Management Component', () => {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.pointDeVentes()[0]).toEqual(expect.objectContaining({ id: 30602 }));
  });

  describe('trackId', () => {
    it('should forward to pointDeVenteService', () => {
      const entity = { id: 30602 };
      jest.spyOn(service, 'getPointDeVenteIdentifier');
      const id = comp.trackId(entity);
      expect(service.getPointDeVenteIdentifier).toHaveBeenCalledWith(entity);
