...
@Service
public class SimphonyEtablissementService {
    ...
    private static final Logger log = LoggerFactory.getLogger(SimphonyEtablissementService.class);

    private final HttpClientService httpClientService;
    private final SimphonyTokenService simphonyTokenService;
    private final KafkaProducerService kafkaProducerService;

    public SimphonyEtablissementService(
    ...
    public CompletableFuture getEtablissementFromTransactionsAPI(String limit, String offset) {
        ...
        return httpClientService
            ...
            .thenAccept(response -> kafkaProducerService.sendMessage("Etablissement", "key", response));
    }

    public CompletableFuture getEtablissementFromContentAPI(Map<String, Object> requestBody) {
        return httpClientService
            .executeHttpRequest(
                HttpMethod.POST,
                "/simphonycontent/v1",
