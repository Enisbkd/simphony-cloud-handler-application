...
export class EtablissementComponent implements OnInit {
  ...
  etablissements = signal<IEtablissement[]>([]);
  isLoading = false;
  ...
  protected readonly etablissementService = inject(EtablissementService);
  protected readonly activatedRoute = inject(ActivatedRoute);
  protected readonly sortService = inject(SortService);
  protected modalService = inject(NgbModal);
  protected ngZone = inject(NgZone);

  trackId = (item: IEtablissement): string => this.etablissementService.getEtablissementIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.etablissements.set(dataFromBody);
  }
