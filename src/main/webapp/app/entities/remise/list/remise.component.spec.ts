...
import { sampleWithRequiredData } from '../remise.test-samples';
...
describe('Remise Management Component', () => {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.remises()[0]).toEqual(expect.objectContaining({ id: 4087 }));
  });

  describe('trackId', () => {
    it('should forward to remiseService', () => {
      const entity = { id: 4087 };
      jest.spyOn(service, 'getRemiseIdentifier');
      const id = comp.trackId(entity);
      expect(service.getRemiseIdentifier).toHaveBeenCalledWith(entity);
