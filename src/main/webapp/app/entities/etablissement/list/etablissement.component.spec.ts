...
describe('Etablissement Management Component', () => {
  ...
  beforeEach(() => {
    ...
    jest
      ...
      .mockReturnValueOnce(
        of(
          new HttpResponse({
            body: [{ id: 'df0f23d6-3c73-4615-bf1e-9ca3de759dd5' }],
      ...
      .mockReturnValueOnce(
        of(
          new HttpResponse({
            body: [{ id: '2af3dd96-06fc-459a-9ec9-11f9c9baa922' }],
            headers: new HttpHeaders({
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.etablissements()[0]).toEqual(expect.objectContaining({ id: 'df0f23d6-3c73-4615-bf1e-9ca3de759dd5' }));
  });

  describe('trackId', () => {
    it('should forward to etablissementService', () => {
      const entity = { id: 'df0f23d6-3c73-4615-bf1e-9ca3de759dd5' };
