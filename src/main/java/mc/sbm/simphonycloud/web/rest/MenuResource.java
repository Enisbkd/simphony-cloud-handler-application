...
import mc.sbm.simphonycloud.service.MenuService;
...
/**
 * REST controller for managing {@link mc.sbm.simphonycloud.domain.Menu}.
 */
@RestController
...
public class MenuResource {
     ...
     */
    @GetMapping("")
    public ResponseEntity<List<MenuDTO>> getAllMenus(@org.springdoc.core.annotations.ParameterObject Pageable pageable) {
