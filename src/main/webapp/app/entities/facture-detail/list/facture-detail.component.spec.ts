...
import { sampleWithRequiredData } from '../facture-detail.test-samples';
...
describe('FactureDetail Management Component', () => {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.factureDetails()[0]).toEqual(expect.objectContaining({ id: 27600 }));
  });

  describe('trackId', () => {
    it('should forward to factureDetailService', () => {
      const entity = { id: 27600 };
      jest.spyOn(service, 'getFactureDetailIdentifier');
      const id = comp.trackId(entity);
      expect(service.getFactureDetailIdentifier).toHaveBeenCalledWith(entity);
